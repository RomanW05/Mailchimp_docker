...
# Write tests cases using pytest for every api call in the module api.py
...
# Run tests: pytest -v --cov=api --cov-report=html --html=report.html --cov-fail-under=100 --cov-report=term --cov-report=term-missing --cov-report=xml --cov-report=annotate --cov-report=html --cov-report=html:htmlcov --cov-report=xml:xmlcov --cov-report=annotate:annotatecov
# Run tests: pytest -v --cov=api --cov-report=html --html=report.html --cov-fail-under=100 --cov-report=term --cov-report=term-missing --cov-report=xml --cov-report=annotate --cov-report=html --cov-report=html:htmlcov --cov-report=xml:xmlcov --cov-report=annotate:annotatecov --cov-report=term-missing:termcov
# Run tests: pytest -v --cov=api --cov-report=html --html=report.html --cov-fail-under=100 --cov-report=term --cov-report=term-missing --cov-report=xml --cov-report=annotate --cov-report=html --cov-report=html:htmlcov --cov-report=xml:xmlcov --cov-report=annotate:annotatecov --cov-report=term-missing:termcov --cov-report=term:termcov
# Run tests: pytest -v --cov=api --cov-report=html --html=report.html --cov-fail-under=100 --cov-report=term --cov-report=term-missing --cov-report=xml --cov-report=annotate --cov-report=html --cov-report=html:htmlcov --cov-report=xml:xmlcov --cov-report=annotate:annotatecov --cov-report=term-missing:termcov --cov-report=term:termcov --cov-report=xml:xmlcov
# Run tests: pytest -v --cov=api --cov-report=html --html=report.html --cov-fail-under=100 --cov-report=term --cov-report=term-missing --cov-report=xml --cov-report=annotate --cov-report=html --cov-report=html:htmlcov --cov-report=xml:xmlcov --cov-report=annotate:annotatecov --cov-report=term-missing:termcov --cov-report=term:termcov --cov-report=xml:xmlcov --cov-report=annotate:annotatecov
# Run tests: pytest -v --cov=api --cov-report=html --html=report.html --cov-fail-under=100 --cov-report=term --cov-report=term-missing --cov-report=xml --cov-report=annotate --cov-report=html --cov-report=html:htmlcov --cov-report=xml:xmlcov --cov-report=annotate:annotatecov --cov-report=term-missing:termcov --cov-report=term:termcov --cov-report=xml:xmlcov --cov-report=annotate:annotatecov --cov-report=html:htmlcov
...
# Fixtures are used to setup and teardown the test cases

# Write the first pytest
# Write the first fixture
# Write the first test case

# Write pytests for the module api.py
# Write fixtures for the module api.py
# Write test cases for the module api.py
...
@pytest.mark.asyncio
async def test_save_template() -> None:
    pass
...
@pytest.mark.asyncio
async def test_add_subscriber() -> None:
    pass

@pytest.mark.asyncio
async def test_new_subscriber() -> None:
    pass
...
@pytest.mark.asyncio
async def test_resubscribe_subscriber() -> None:
    pass

@pytest.mark.asyncio
async def test_create_campaign() -> None:
    result = requests.get('http://localhost:8000/create_campaign')
...
@pytest.mark.asyncio
async def test_save_campaign() -> None:
    # Mock html form response so that request returns a dict

    request = mock()
    request.form = {'name': 'new_campaign_test'}
    ...
    # form_data = await request.form()
    # results = jsonable_encoder(form_data)
    # and so results['name'] = 'new_campaign_test'
...
@pytest.mark.asyncio
async def test_launch_campaign() -> None:
    pass

@pytest.mark.asyncio
async def test_send_emails() -> None:
    pass

@pytest.mark.asyncio
async def test_white_pixel() -> None:
    pass

@pytest.mark.asyncio
async def test_view_stats() -> None:
    pass
